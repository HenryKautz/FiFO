;;; Intrusion-detection domain from the Ramirez & Geffner plan-recognition
...
;;; intrusion-detection/intrusion-detection-aaai problems).  An attacker
;;; performs recon on hosts and then gathers information, vandalizes, or
;;; steals data; each candidate goal names an attacker objective over a
;;; subset of the hosts.  Unmodified STRIPS.
